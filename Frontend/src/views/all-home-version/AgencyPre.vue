...
this.sliderContent[0].title = this.newForm.text1
        ...
        this.sliderContent[3].title = this.newForm.text7
        this.sliderContent[3].desc = this.newForm.text8
        this.sliderContent[3].src = this.newForm.pic4
        this.sliderContent[4].title = this.newForm.text9
        this.sliderContent[4].desc = this.newForm.text10
        this.sliderContent[4].src = this.newForm.pic5

this.portfolioContent[0].title =this.newForm.text11
this.portfolioContent[0].src = this.newForm.pic6
this.portfolioContent[1].title =this.newForm.text12
this.portfolioContent[1].src = this.newForm.pic7
this.portfolioContent[2].title =this.newForm.text13
this.portfolioContent[2].src = this.newForm.pic8

console.log(123123);
console.log(this.sliderContent[0]);
}
});
}
}
