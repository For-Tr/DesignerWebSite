    ...
    <div class="form-container">
      <div class="preview-section">
        ...
        >
          <iframe 
            ref="previewIframe"
            src="http://localhost:8080/freelancerPre" 
            frameborder="0"
        ...
        <form @submit.prevent="submitForm">
          ...
          <div class="form-section">
            ...
            <div class="upload-section">
              ...
              <div class="input-group">
                <label>Text 8</label>
                <input type="text" v-model="form.text8" @input="handleTextInput('text8', $event.target.value)" placeholder="Enter text 1" maxlength="500">
              </div>
            ...
            <v-file-input
                ...
                label="Upload Files (Images/Videos/PDF)"
                placeholder="Pick files for section 1"
                @change="(file) => {beforeUpload(file, 'pic7')}"
                :show-size="true"
              ...
              <div class="input-group">
                <label>Text 10</label>
                <input type="text" v-model="form.text10" @input="handleTextInput('text10', $event.target.value)" placeholder="Enter text 1" maxlength="500">
              </div>
              ...
              <v-file-input
                ...
                label="Upload Files (Images/Videos/PDF)"
                placeholder="Pick files for section 1"
                @change="(file) => {beforeUpload(file, 'pic8')}"
                :show-size="true"
              ...
              <div class="input-group">
                <label>Text 11</label>
                <input type="text" v-model="form.text11" @input="handleTextInput('text11', $event.target.value)" placeholder="Enter text 1" maxlength="500">
              </div>
              ...
              <v-file-input
                ...
                label="Upload Files (Images/Videos/PDF)"
                placeholder="Pick files for section 1"
                @change="(file) => {beforeUpload(file, 'pic9')}"
                :show-size="true"
              ...
              <div class="input-group">
                <label>Text 12</label>
                <input type="text" v-model="form.text12" @input="handleTextInput('text12', $event.target.value)" placeholder="Enter text 1" maxlength="500">
              </div>
