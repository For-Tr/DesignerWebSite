    ...
    <div class="form-container">
      <div class="preview-section">
        ...
        >
          <iframe 
            ref="previewIframe"
            src="http://localhost:8080/agencyPre" 
            frameborder="0"
        ...
        <form @submit.prevent="submitForm">
          ...
          <div class="form-section">
            ...
            <div class="upload-section">
              ...
              <div class="input-group">
                <label>Text 13</label>
                <input type="text" v-model="form.text13" @input="handleTextInput('text13', $event.target.value)" placeholder="Enter text 1" maxlength="500">
              </div>
