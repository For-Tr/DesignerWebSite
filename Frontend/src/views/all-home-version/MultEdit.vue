...
<div class="form-container">
  <div class="preview-section">
    ...
    >
      <iframe 
        ref="previewIframe"
        src="http://localhost:8080/multiscroll-portfolioPre" 
        frameborder="0"
      ...
      <div class="form-section">
        ...
        <div class="upload-section">
          <v-file-input
            accept="image/*, video/*, application/pdf"
            label="Upload Files (Images/Videos/PDF)"
            placeholder="Pick files for section 4"
      ...
      <div class="form-section">
        ...
        <div class="upload-section">
          <v-file-input
            accept="image/*, video/*, application/pdf"
            label="Upload Files (Images/Videos/PDF)"
            placeholder="Pick files for section 5"
        ...
        <div class="text-inputs">
          <div class="input-group">
            <label>Text 12</label>
            <input type="text" v-model="form.text12" @input="handleTextInput('text12', $event.target.value)" placeholder="Enter text 12" maxlength="500">
          </div>
          <div class="input-group">
            <label>Text 13</label>
            <input type="text" v-model="form.text13" @input="handleTextInput('text13', $event.target.value)" placeholder="Enter text 13" maxlength="500">
          </div>
          <div class="input-group">
            <label>Text 14</label>
            <input type="text" v-model="form.text14" @input="handleTextInput('text14', $event.target.value)" placeholder="Enter text 14" maxlength="500">
          </div>
        </div>
      </div>
