    ...
    <div class="form-container">
      <div class="preview-section">
        ...
        >
          <iframe 
            ref="previewIframe"
            src="http://localhost:8080/main-demoPre" 
            frameborder="0"
        ...
        <form @submit.prevent="submitForm">
          ...
          <div class="form-section">
            ...
            <div class="upload-section">
              ...
              <div class="input-group">
                <label>Text 9</label>
                <input type="text" v-model="form.text9" @input="handleTextInput('text9', $event.target.value)" placeholder="Enter text 1" maxlength="500">
              </div>
            </div>
            <v-file-input
                accept="image/*, video/*, application/pdf"
              ...
              <div class="text-inputs">
                ...
                <div class="input-group">
                <label>Text 10</label>
                <input type="text" v-model="form.text10" @input="handleTextInput('text10', $event.target.value)" placeholder="Enter text 2" maxlength="500">
              </div>
              <div class="input-group">
                <label>Text 11</label>
                <input type="text" v-model="form.text11" @input="handleTextInput('text11', $event.target.value)" placeholder="Enter text 2" maxlength="500">
              </div>
              <div class="input-group">
                <label>Text 12</label>
                <input type="text" v-model="form.text12" @input="handleTextInput('text12', $event.target.value)" placeholder="Enter text 2" maxlength="500">
              </div>
            </div>
            <v-file-input
                accept="image/*, video/*, application/pdf"
                label="Upload Files (Images/Videos/PDF)"
                placeholder="Pick files for section 1"
                @change="(file) => {beforeUpload(file, 'pic5')}"
                :show-size="true"
              ...
              <div class="input-group">
                <label>Text 13</label>
                <input type="text" v-model="form.text13" @input="handleTextInput('text13', $event.target.value)" placeholder="Enter text 2" maxlength="500">
              </div>
              <div class="input-group">
                <label>Text 14</label>
                <input type="text" v-model="form.text14" @input="handleTextInput('text14', $event.target.value)" placeholder="Enter text 2" maxlength="500">
              </div>
              <div class="input-group">
                <label>Text 15</label>
                <input type="text" v-model="form.text15" @input="handleTextInput('text15', $event.target.value)" placeholder="Enter text 2" maxlength="500">
              </div>
